"""
Testing of :mod:`carpet_concentrations.time`
"""
import re
...
from carpet_concentrations.testing import get_call_kwargs
...
@patch("carpet_concentrations.time.partial")
@patch("carpet_concentrations.time.convert_to_time")
